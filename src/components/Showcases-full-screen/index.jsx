...
import categorias from "../../data/sections/categorias.json";
import SwiperCore, {
  Navigation,
  Pagination,
  Parallax,
  ...
  return (
    <header className="slider showcase-full">
      ...
      <div className="txt-botm">
        ...
        >
          <div>
            <span className=" custom-font">Categoria Anterior</span>
          </div>
          <div>
        ...
        >
          ...
          <div>
            <span className=" custom-font">Categoria Siguiente</span>
          </div>
        </div>
      </div>
      <div
